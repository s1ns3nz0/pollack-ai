...
def _normalize_severity(raw: str) -> str:
    ...
    """
    return SEVERITY_ALIASES.get(raw.strip().lower(), SEVERITY_ALIASES.get(raw.strip(), "medium"))
...
def render_textfile(metrics: OSCALMetrics) -> str:
    ...
    """
    lines: list[str] = []
    lines.append("# HELP oscal_controls_total Adopted AI RMF controls by implementation status.")
    ...
    lines.append("")
    lines.append("# HELP oscal_last_build_timestamp Unix epoch (s) of last OSCAL build.")
